        ...
        <>
            <header className="bg-white shadow-xs sticky top-0 z-50">
                <div className="mx-4 sm:mx-8 md:mx-16 xl:mx-20 p-4">
                    {/* Use flex to align items and make the container full width */}
                    <div className="flex items-center w-full">
                        ...
                        <div className="flex-grow mx-4">
                            <div className="relative w-full flex items-center">
                                ...
                                {/* Search button */}
                                <button className="absolute right-0 top-0 bottom-0 my-auto mr-1 flex items-center justify-center">
                            ...
                            <div className="relative pr-2" ref={languageDropdownRef}>
                                ...
                                {isLanguageDropdownOpen && (
                                    <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-300 rounded-lg shadow-lg z-50">
                                        <a href="/lang/en" className="block px-4 py-2 text-gray-800 hover:bg-gray-100">English</a>
                                        <a href="/lang/es" className="block px-4 py-2 text-gray-800 hover:bg-gray-100">Spanish</a>
                                        <a href="/lang/ca" className="block px-4 py-2 text-gray-800 hover:bg-gray-100">Catalan</a>
                                    </div>
                                )}
                            </div>
