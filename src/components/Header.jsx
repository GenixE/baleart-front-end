                            ...
                            <div className="relative" ref={userDropdownRef}>
                                ...
                                >
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                         fill={isLoggedIn ? "#149d80" : "currentColor"} className="w-10 h-10">
                                        <path fillRule="evenodd"
                                            ...
                                            <>
                                                <button onClick={() => {
                                                    ...
                                                    setIsAuthModalOpen(true);
                                                        ...
                                                        className="block w-full text-left px-4 py-2 text-gray-800 hover:bg-gray-100">Login
                                                </button>
                                                <button onClick={() => {
                                                    setAuthModalType('register');
                                                    setIsAuthModalOpen(true);
                                                }}
                                                        className="block w-full text-left px-4 py-2 text-gray-800 hover:bg-gray-100">Register
                                                </button>
                                            </>
                                        )}
                                    </div>
