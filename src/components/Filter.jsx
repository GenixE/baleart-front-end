                ...
                >
                    ...
                    {spaceTypes.map((type) => (
                        <SwiperSlide key={type.id}>
                            <div className="flex flex-col items-center space-y-1 mx-16">
                                {/* Use the icon based on the description_EN or name */}
                                {icons[type.description_EN] || (
                                    // Fallback icon if one isn’t defined for this type
