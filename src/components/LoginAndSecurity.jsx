...
export function LoginAndSecurity() {
    ...
    return (
        <div className="max-w-7xl min-w-[48rem] mx-auto p-8 space-y-8">
            ...
            <h1 className="text-3xl font-semibold mb-8">Login & Security</h1>
            ...
            <StyledForm>
                ...
                <div className="border-b border-gray-200 pb-6">
                    <div className="flex justify-between items-center">
                        <span className="text-lg font-semibold text-gray-800 min-w-[200px]">Password</span>
                        {editField !== 'password' ? (
                            <button
                ...
                <div className="border-b border-gray-200 pb-6">
                    <div className="flex justify-between items-center">
                        <span className="text-lg font-semibold text-gray-800 min-w-[200px]">Delete Account</span>
                        {!showDeleteConfirm ? (
                            <button
